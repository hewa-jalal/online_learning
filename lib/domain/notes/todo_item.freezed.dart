...
mixin _$TodoItem {
  UniqueId get id;
  TodoName
      get name; // we can't validate a bool so we don't wrap this inside a value object
  bool get done;
...
class _$_TodoItem extends _TodoItem with DiagnosticableTreeMixin {
  ...
  @override
  final TodoName name;
  @override // we can't validate a bool so we don't wrap this inside a value object
  final bool done;
