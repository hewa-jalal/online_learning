...
import 'features/lectures/domain/usecases/get_all_lectures_by_user_id.dart'
    as _i32;
import 'features/lectures/domain/usecases/get_all_submitted_users.dart' as _i33;
...
import 'features/user/domain/usecase/get_users.dart' as _i34;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i32.GetAllLecturesByCourse>(() =>
      _i32.GetAllLecturesByCourse(
          lecturesRepository: get<_i15.LecturesRepository>()));
  gh.lazySingleton<_i33.GetAllSubmittedUsers>(() => _i33.GetAllSubmittedUsers(
      lecturesRepository: get<_i15.LecturesRepository>()));
  gh.lazySingleton<_i34.GetAllUsers>(
      () => _i34.GetAllUsers(get<_i24.UserRepository>()));
  ...
  gh.factory<_i36.LectureBloc>(() => _i36.LectureBloc(
      ...
      getAllSubmittedUsers: get<_i33.GetAllSubmittedUsers>()));
  ...
  gh.factory<_i39.UserAuthBloc>(() => _i39.UserAuthBloc(
      ...
      getAllUsers: get<_i34.GetAllUsers>(),
